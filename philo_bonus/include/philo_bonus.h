...
# define SEM4WAITER "/waiter"
# define NUM_OF_WAITER 1
...
void	ft_start_processes(t_philo *philos, sem_t **forks, sem_t **waiter, \
t_config *config);

/* init_n_clear_sems.c */
void	ft_clear_sems(sem_t *forks, sem_t *waiter);
void	ft_init_sems(sem_t **forks, sem_t **waiter, t_config **config);

/* start_n_stop_sem_n_ths.c */
void	ft_start_sem_n_ths(t_philo *philo, pthread_t *th_philo, \
pthread_t *th_dr);
void	ft_stop_sem_n_ths(t_philo *philo, pthread_t th_philo, pthread_t th_dr);
void	ft_open_sems(t_philo *philo);
